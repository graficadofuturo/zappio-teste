    ...
    <div className="min-h-screen bg-[#fafafa] text-[#111827] font-sans selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 flex-shrink-0 bg-emerald-600 rounded-lg flex items-center justify-center">
                <Zap className="w-5 h-5 text-white" />
            </div>
            <span className="text-[18px] font-extrabold tracking-tight text-gray-900">Zappio <span className="text-xs bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded font-mono ml-1">V2</span></span>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Link to="/overview" className="text-[14px] font-semibold text-emerald-600 hover:text-emerald-700 transition-colors">Acessar Painel</Link>
            <Link to="/overview" className="text-[14px] font-semibold bg-emerald-600 text-white px-5 py-2 rounded-lg hover:bg-emerald-700 transition-all shadow-sm">
              Entrar (Conexão Automática)
            </Link>
          </div>
        </div>
      </header>
      ...
      <section className="relative pt-24 pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col items-center text-center">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-100 text-[12px] font-semibold text-emerald-700 mb-8"
            >
              <Zap className="w-4 h-4" />
              Zappio V2: Nova versão premium com bypass de login automático
            </motion.div>
            ...
            >
              Automatize ofertas no WhatsApp e <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500">venda no piloto automático</span>
            </motion.h1>
            ...
            >
              Conecte seu WhatsApp, configure sua conta de afiliado e deixe o Zappio V2 buscar ofertas reais, gerar links de afiliado convertidos e disparar automaticamente sem repetir produtos.
            </motion.p>
            ...
            >
              <Link to="/overview" className="flex items-center justify-center gap-2 bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold text-[16px] hover:bg-emerald-700 transition-all shadow-sm hover:shadow-md w-full sm:w-auto">
           ...
           <div className="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden flex flex-col md:flex-row relative">
              ...
              <div className="w-full md:w-[320px] bg-[#efeae2] p-6 flex flex-col pt-10 relative">
                 ...
                 <div className="bg-white p-3 rounded-tr-xl rounded-b-xl shadow-sm mb-4 max-w-[90%] relative">
                   ...
                   <p className="text-[13px] text-gray-885 leading-relaxed font-sans whitespace-pre-wrap">
                      🔥 Oferta relâmpago!
                      <br/><br/>
      ...
      <section id="features" className="py-24 bg-gray-50 border-t border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
             {[
                { title: "Disparo Automático", icon: Zap, desc: "Agende intervals ou deixe em disparo contínuo sem intervenção manual." },
      ...
      <section className="py-24 bg-emerald-600">
         <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-[18px] text-emerald-100 mb-10 max-w-2xl mx-auto">Acesse o painel agora e comece a transformar seu WhatsApp.</p>
            <Link to="/overview" className="inline-flex items-center justify-center gap-2 bg-white text-emerald-600 px-10 py-5 rounded-2xl font-bold text-[18px] hover:bg-gray-50 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1">
               Acessar Painel Gratuitamente
            </Link>
         </div>
      </section>
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
              <div className="col-span-2">
                 <div className="flex items-center gap-2 mb-4">
                    <div className="w-6 h-6 flex-shrink-0 bg-emerald-600 rounded flex items-center justify-center">
                        <Zap className="w-3 h-3 text-white" />
                    </div>
                    <span className="text-[16px] font-extrabold tracking-tight text-gray-900">Zappio V2</span>
                  </div>
